...
public class UploadedBinaries : IVersionedEntityChild {
  ...
  /// <summary>
  /// Indicates the date and time when the plugin binary entry was created.
  /// Automatically set to the current UTC time at the moment of record creation.
  /// </summary>
  public DateTimeOffset CreatedAt { get; set; } = DateTimeOffset.UtcNow;

  /// <summary>
  /// Represents the file resource associated with the uploaded binaries.
  /// Defines a reference to a file stored in the database, ensuring its existence and relation to the binary.
  /// </summary>
  public FileResource File { get; set; } = null!;

  /// <summary>
  /// Represents the identifier associated with the file resource for the uploaded binaries.
  /// Used as a foreign key to link the uploaded binaries with the corresponding file resource.
  /// </summary>
