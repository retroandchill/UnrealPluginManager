...
public static partial class EngineVersionUtils {
  ...
  public static Version GetEngineVersion(this IFileSystem fileSystem, string installDirectory) {
    ...
    return localEngineVersionPatch.IsSome
        ? new Version(localEngineVersionMajor.OrElseThrow(), localEngineVersionMinor.OrElseThrow(),
                      localEngineVersionPatch.OrElseThrow())
        : new Version(localEngineVersionMajor.OrElseThrow(), localEngineVersionMinor.OrElseThrow());
  }
