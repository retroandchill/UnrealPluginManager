        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    author_name = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    author_website = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    version_string = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    ...
                    metadata = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    parent_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    plugin_name = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    plugin_version = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
